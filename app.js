...
window.toggleTerm=element=>{ const shown=element.classList.toggle('show-meaning'); element.textContent=shown?decodeURIComponent(element.dataset.meaning):decodeURIComponent(element.dataset.term); };
