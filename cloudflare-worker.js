...
const lessonSchema = { type:'object', additionalProperties:false, properties:{ lessons:{ type:'array', items:{ type:'object', additionalProperties:false, properties:{ title:{type:'string'}, meaning:{type:'string'}, sentence:{type:'string'}, translation:{type:'string'}, explanation:{type:'string'}, tag:{type:'string'}, keyTerms:{type:'array',items:{type:'object',additionalProperties:false,properties:{term:{type:'string'},meaning:{type:'string'}},required:['term','meaning']},maxItems:2} }, required:['title','meaning','sentence','translation','explanation','tag','keyTerms'] } } }, required:['lessons'] };
